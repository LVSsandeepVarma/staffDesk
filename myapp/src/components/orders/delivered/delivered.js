...
import DeliveredTable from "./delviredTable"
            ...
            <div className="container-scroller  sm:relative top-[0px] sm:top-[60px] md:top-[100px] lg:top-[0px] marqueePosition">
                ...
                <div className="page-header container">
                    ...
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item active"aria-current="page" >Delivered</li>
                    </ol>
                    {/* <!-- End breadcrumb --> */}
                ...
                <div className=" page-header container 	"style={{display:"block"}}>
                    ...
                    <button type="button" onClick={()=>navigate("/enquiry/orders/dispatched")} className="btn btn-outline-secondary !text-[#28afd0] position-relative mr-2 py-2 fs-14"> Dispatched | {userData?.value?.data?.enq_counts?.ringing} </button>
                    <button type="button" onClick={()=>navigate("/enquiry/orders/delivered")} className="btn btn-outline-secondary text-white !bg-[#467fcf]  position-relative mr-2 py-2 fs-14"> Delivered | {userData?.value?.data?.enq_counts?.postponed} </button>
