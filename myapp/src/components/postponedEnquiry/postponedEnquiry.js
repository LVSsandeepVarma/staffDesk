...
import PostponedTable from "./postponedTable"
import { useNavigate } from "react-router-dom"
// import { useRouter } from "next/navigation"
export default function Postponed_Enquiry() {
            ...
            <div className="container-scroller  ">
                ...
                <div className="page-header container ">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item active" aria-current="page">Postponed</li>
                    </ol>
                    {/* <!-- End breadcrumb --> */}
                ...
                <div className=" page-header container " style={{display:"block"}}>
                    ...
                    <button type="button" onClick={()=>navigate("/enquiry/postponed-enquiry")} className="btn btn-outline-secondary text-white !bg-[#5eba00] position-relative mr-2 py-2 fs-14"> Postponed | {userData?.value?.data?.enq_counts?.postponed} </button>
