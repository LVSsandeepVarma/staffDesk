...
import NotIntrestedTable from "./notIntrestedTable"
import { useNavigate } from "react-router-dom"
// import { useRouter } from "next/navigation"

export default function Not_Intrested_Enquiry() {
        ...
        <>
            <div className="container-scroller  ">
                ...
                <div className=" page-header container" style={{display:"block"}}>
                    ...
                    <button type="button" onClick={()=>navigate("/enquiry/not-intersted-enquiry")} className="btn btn-outline-secondary text-white !bg-[#f66] position-relative mr-2 py-2 fs-14"> Not Intrested | {userData?.value?.data?.enq_counts?.notin}  </button>
