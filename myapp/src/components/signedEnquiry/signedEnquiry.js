...
import TodaysPostponedTable from "../todaysPostponed/todaysPostponedTable"
        ...
        <>
            <div className="container-scroller  ">
                ...
                <div className="container">
                    <Card>
                        <Card.Title className="card-header border-bottom py-3 !bg-[#25378b] text-white">Signed Enquiries</Card.Title>
                        <Card.Body>
